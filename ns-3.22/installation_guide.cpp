// Simple GUI for easier installation of ns-3 versions
...
int main(int argc, char* argv[]) {
	...
	gtk_label_set_markup(GTK_LABEL(label_text2), "After installation press Close and Exit button!");
	gtk_fixed_put(GTK_FIXED(fixed), label_text2, 7, 90);
	gtk_widget_set_size_request(label_text2, 350, 35);
